    ...
    <footer className="border-t hairline bg-[color:var(--ink)] text-[color:var(--paper)]">
      <div className="container-wide grid gap-10 py-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm leading-7 text-white/70">
            Studio privé en maison à Villiers-sur-Morin (77580). Les projets personnalisés et les flashs sont étudiés avec soin. L’adresse exacte est communiquée après la prise de rendez-vous.
          </p>
        </div>
        ...
        <div>
          <p className="text-sm font-bold text-white">Contact et informations</p>
          ...
          <div className="mt-6 grid gap-3 text-sm text-white/68">
            ...
            <Link href="/cookies" className="transition hover:text-white">Cookies et statistiques</Link>
            <Link href="/cgv/flash-septembre" className="transition hover:text-white">CGV Flash Septembre</Link>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/10 py-4">
        <div className="container-wide flex flex-col gap-2 text-xs text-white/50 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p>Flash Septembre : acompte en ligne via prestataire sécurisé.</p>
        </div>
      </div>
    </footer>
  );
